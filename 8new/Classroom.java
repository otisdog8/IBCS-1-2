...
class Classroom {
    ...
    public void jsave(String filename) {
        try {
    ...
    public boolean tload(String filename) {
        try {
    ...
    public boolean sload(String object) {
        return false;
    }
    ...
    public void delete(Student student) {
        ...
        int offset;
        for (int i = 0; i < this.filelength; i++) {
            if (student.studentnumber == this.students[i].studentnumber) {
                this.filelength--;
                offset = 0;
...
class StudentIDComparator implements Comparator<Student> {
    public int compare(Student o1, Student o2) {
        return (int) Math.signum(o1.studentnumber - o2.studentnumber);
    }
